...
- `learner-centered-rebuild.json` records the complete, independently reviewed
  retain/remove decision for every v1.0.0 entry.
...
- Accepted evidence lives in schema-version-2 files under `../catalog/` and is
