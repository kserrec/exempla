...
language scope. Every other language JSON file is schema version 3 and is the
...
it without external Python packages and generates only from schema version 3.
