...
- Before reading `Get-LatestMsBuildPath`, be familiar with PowerShell functions, arrays, filesystem paths, sorting, exceptions, mocking, and the basic idea that Visual Studio and MSBuild versions install executables in different conventional directories.
...
**Inspection record:** commit `7fee8e141296ea6c337e433537d7061f52e24157`, reviewed 2026-08-29 by Codex, independent Codex reviewer. Files sampled: `src/Invoke-MsBuild/Invoke-MsBuild.psm1`, `src/Tests/Invoke-MsBuild.Tests.ps1`, `ReadMe.md`, `License.md`. GitHub Linguist label: PowerShell.
...
- Before reading `Import-Ini.ps1`, be familiar with PowerShell advanced functions, parameter sets, pipelines, hashtables, regular expressions, text encodings, and basic Pester assertions.
...
**Inspection record:** commit `6895c42fdba461a1a171fe70e11d67c037bac1d0`, reviewed 2026-08-29 by Codex, independent Codex reviewer. Files sampled: `PSIni/Public/Import-Ini.ps1`, `Tests/Import-Ini.Unit.Tests.ps1`, `README.md`, `LICENSE`. GitHub Linguist label: PowerShell.
...
**Inspection record:** commit `512a99018dc13027de2d746d5467c4d39a9401b2`, reviewed 2026-08-29 by Codex, independent Codex reviewer. Files sampled: `src/Public/Routes.ps1`, `src/Private/Routes.ps1`, `tests/unit/Routes.Tests.ps1`, `README.md`, `LICENSE.txt`. GitHub Linguist label: PowerShell.
...
**Inspection record:** commit `5387c061461c811d106b125588f064c4739342cb`, reviewed 2026-08-29 by Codex, independent Codex reviewer. Files sampled: `Public/Import-Excel.ps1`, `Public/Open-ExcelPackage.ps1`, `Public/Close-ExcelPackage.ps1`, `__tests__/ImportExcelTests/Simple.tests.ps1`, `__tests__/ImportExcelTests/ImportExcelEndRowEndColumn.tests.ps1`, `__tests__/ImportExcelTests/ImportExcelReadSheets.tests.ps1`, `README.md`, `LICENSE.txt`. GitHub Linguist label: PowerShell.
...
**Inspection record:** commit `3b19a45518b99aded3ecc20e709d96a19a3e937b`, reviewed 2026-08-29 by Codex, independent Codex reviewer. Files sampled: `Source/Public/Merge-ScriptBlock.ps1`, `Source/Private/ConvertToAst.ps1`, `Source/Classes/10. TextReplacement.ps1`, `Source/Public/Invoke-ScriptGenerator.ps1`, `Tests/Private/ConvertToAst.Tests.ps1`, `Tests/Public/Merge-ScriptBlock.Tests.ps1`, `ReadMe.md`, `LICENSE`. GitHub Linguist label: PowerShell.
