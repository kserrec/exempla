...
- Readers should know advanced Lua, OpenResty and Nginx worker phases, timers and shared dictionaries, event callbacks, schema validation, versioned configuration, HTTP and stream routing, and asynchronous failure handling.
